    ...
    public function index()
    {
        ...
        if ($search) {
            ...
            if ($bibliotecas->isNotEmpty()) {
                $totalBusqueda=$bibliotecas->count();
                session()->flash('success',"Resultados de busqueda $totalBusqueda resultados");
            } return view('bibliotecas.index')->with('bibliotecas',$bibliotecas)->with('search', $search);
        }
        else{
            $bibliotecas=biblioteca::all();
            return view('bibliotecas.index')->with('bibliotecas',$bibliotecas);
        }
